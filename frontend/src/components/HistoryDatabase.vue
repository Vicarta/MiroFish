        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step 3 "Run Simulation" and Step 5 "Deep Interaction" must be started live and are not available as historical replay.</span>
            </div>
          </div>
        </div>
      </Transition>
...
const selectedProject = ref(null)  // Current选中的项目（用于弹窗）
let observer = null
...
// 格式化轮数显示（Current round/Total rounds）
